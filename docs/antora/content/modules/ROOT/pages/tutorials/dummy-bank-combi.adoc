...
TIP: Basically, we need a Combi field for each decision that sould be made on the user flow.
...
image:images/dummy-bank-combi/analyze1.png["analyze result"]
...
[.text-center]
image:images/dummy-bank-combi/testSpaceSM.png["analyze result",200px,align="center"]
...
image:images/dummy-bank-combi/testSpaceFull.png["analyze result"]
// TODO -  rephrase
...
// Should i use the table below to describe the statemachine?
